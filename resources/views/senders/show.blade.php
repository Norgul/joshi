...
@section('content')
    ...
    @if ($sender->status != MailChamp\Model\Sender::STATUS_NEW)
            ...
            <div class="row">
                <div class="col-sm-12 col-md-8">
                   <h3>{{ trans('messages.sender.verification_status') }}</h3>
                    ...
                    @if ($sender->type == MailChamp\Model\Sender::VERIFICATION_TYPE_ACELLE)
    ...
    <div class="sub_section verify_sender_container {{ $sender->status != MailChamp\Model\Sender::STATUS_NEW ? 'hide' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    @include('helpers.form_control', [
                        ...
                        'name' => 'type',
                        'value' => $sender->type,
                        'options' => MailChamp\Model\Sender::verificationTypeSelectOptions(),
