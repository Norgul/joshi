...
@section('content')
    ...
    <form class="listing-form"
          ...
          per-page="{{ MailChamp\Model\Sender::$itemsPerPage }}"
    >
        ...
        <div class="row top-list-controls">
            ...
            <div class="col-md-3">
                @if (Auth::user()->can('create', new MailChamp\Model\Sender()))
...
{{--        </ul>--}}
{{--        <h1>--}}
{{--            <span class="text-semibold"><i class="icon-list2"></i> {{ trans('messages.verified_senders') }}</span>--}}
{{--        </h1>--}}
{{--    </div>--}}
{{--@endsection--}}
