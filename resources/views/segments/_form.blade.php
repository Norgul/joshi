                    <div class="sub_section">
						<div class="row">
							<div class="col-md-8">
								@include('helpers.form_control', ['type' => 'text', 'name' => 'name', 'value' => $segment->name, 'rules' => MailChamp\Model\Segment::$rules])
							</div>
							<div class="col-md-4">
								@include('helpers.form_control', ['type' => 'select', 'name' => 'matching', 'label' => trans('messages.how_subscribers_matching'), 'value' => $segment->matching, 'help_class' => 'segment', 'options' => MailChamp\Model\Segment::getTypeOptions(), 'rules' => MailChamp\Model\Segment::$rules])
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
