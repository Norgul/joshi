        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="sub-section">
                ...
                <form action="{{ action('SubscriberController@store', $list->uid) }}" method="POST" class="form-validate-jquery">
                    ...
                    @if (\MailChamp\Model\Setting::get('import_subscribers_commitment'))
                        <hr>
                        <div class="mt-40">
                            @include('helpers.form_control', [
                                ...
                                'value' => 'no',
                                'required' => true,
                                'label' => \MailChamp\Model\Setting::get('import_subscribers_commitment'),
                                'options' => ['no','yes'],
                                'rules' => []
                            ])
                        </div>
    ...
    .select2-container--default .select2-selection--multiple .select2-selection__choice {
        background-color: black;
                    ...
                    <div class="text-left">
                        ...
                        <a href="{{ action('SubscriberController@index', $list->uid) }}" class="btn bg-grey-800"><i
                                    class="icon-cross2"></i> {{ trans('messages.cancel') }}</a>
                    </div>
                    </form>
            </div>
        </div>
