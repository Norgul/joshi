<div class="row">
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
            ...
            'rules' => MailChamp\Model\FeedbackLoopHandler::rules()
        ])
    </div>
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
            ...
            'options' => MailChamp\Model\FeedbackLoopHandler::protocolSelectOptions(),
            'help_class' => 'feedback_loop_handler',
            'rules' => MailChamp\Model\FeedbackLoopHandler::rules()
        ])
    </div>
...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        @include('helpers.form_control', [
            ...
            'options' => MailChamp\Model\FeedbackLoopHandler::encryptionSelectOptions(),
            'help_class' => 'feedback_loop_handler',
            'rules' => MailChamp\Model\FeedbackLoopHandler::rules()
        ])
    </div>
