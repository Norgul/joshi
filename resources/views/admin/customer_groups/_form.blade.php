          <div class="sub_section">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    @include('helpers.form_control', ['type' => 'text', 'name' => 'name', 'value' => $group->name, 'help_class' => 'customer_group', 'rules' => MailChamp\Model\CustomerGroup::$rules])
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="top-tab1">
                                    ...
                                    <div class="row">
                                        <div class="boxing col-md-3">
                                            @include('helpers.form_control', [
                                                ...
                                                'options' => ['true', 'false'],
                                                'rules' => MailChamp\Model\CustomerGroup::rules()
                                            ])
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @include('helpers.form_control', ['type' => 'select',
                                                    ...
                                                    'label' => '',
                                                    'options' => MailChamp\Model\CustomerGroup::multiProcessSelectOptions(),
                                                    'help_class' => 'customer_group',
                                                    'rules' => MailChamp\Model\CustomerGroup::rules()
                                                ])
                                            </div>
                                    ...
                                    <div class="row sending-servers">
                                        @foreach (MailChamp\Model\SendingServer::getAll()->orderBy("name")->get() as $server)
