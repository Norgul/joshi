<div class="sub_section">
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', ['type' => 'text', 'name' => 'name', 'value' => $group->name, 'help_class' => 'admin_group', 'rules' => MailChamp\Model\AdminGroup::$rules])
        </div>
    </div>
</div>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="top-tab1">
                @foreach (MailChamp\Model\AdminGroup::allPermissions() as $key => $items)
                            ...
                            <div class="col-md-3">
                                @if (count($ops["options"]) > 2)
                                    @include('helpers.form_control', [
                                        ...
                                        'rules' => MailChamp\Model\AdminGroup::rules()
                                    ])
                                @else
