                    ...
                    @if ($setting['cat'] == 'license')
                        @if ($current_license)
							<div class="sub-section">
								...
								<p>{{ trans('messages.your_current_license') }} <strong>{{ trans('messages.license_label_' . \MailChamp\Model\Setting::get('license_type')) }}</strong></p>
								<h4>
									{{ $current_license }}
								</h4>
							</div>
							...
							<div class="row license-line">
								<div class="col-md-6">
									@include('helpers.form_control', [
										...
										'rules' => MailChamp\Model\Setting::rules(),
									])
								</div>
								<div class="col-md-6">
									<br />
