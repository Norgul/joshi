                            ...
                            >
								@foreach ($items as $key => $item)
									<tr>
										...
										<td>
											<div class="single-stat-box pull-left ml-20">
												<span class="text-muted"><strong>{{ number_with_delimiter($item->getSendingQuotaUsage()) }}</strong> {{ trans('messages.' . MailChamp\Library\Tool::getPluralPrase('email', $item->getSendingQuotaUsage()) . '_quota') }}</span>
												<br />
