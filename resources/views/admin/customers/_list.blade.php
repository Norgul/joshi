            ...
            <tr>
                ...
                <td class="stat-fix-size">
                    <div class="single-stat-box pull-left ml-20">
                        ...
                        <span class="text-muted"><strong>{{ \MailChamp\Library\Tool::format_number($item->getSendingQuotaUsage()) }}/{{ ($item->getSendingQuota() == -1) ? '∞' : \MailChamp\Library\Tool::format_number($item->getSendingQuota()) }}</strong>
