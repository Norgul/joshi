...
@section('content')
    ...
    <form class="listing-form"
        ...
        per-page="{{ MailChamp\Model\Subscription::$itemsPerPage }}"
    >
        ...
        <div class="row top-list-controls">
                ...
                <div class="filter-box">
					...
					<span class="filter-group">
						<select class="select" name="status">
							...
							@foreach (MailChamp\Model\Subscription::statusSelectOptions() as $option)
                    ...
                    <span class="filter-group">
                        <select class="select" name="time_status">
                            ...
                            @foreach (MailChamp\Model\Subscription::timeStatusSelectOptions() as $option)
                                <option value="{{ $option['value'] }}">
                                    {{ $option['text'] }}
                                </option>
                            @endforeach
                    ...
                    <span class="filter-group">
                        <select class="select" name="paid_status">
                            ...
                            @foreach (MailChamp\Model\Subscription::paidStatusSelectOptions() as $option)
                                <option value="{{ $option['value'] }}">
                                    {{ $option['text'] }}
                                </option>
                            @endforeach
            ...
            @if(Auth::user()->admin->can('create', new MailChamp\Model\Subscription()))
