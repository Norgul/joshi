<div class="tabbable">
    <ul class="nav nav-tabs nav-tabs-top">
        <li class="
        {{ request()->route()->getActionName() == 'MailChamp\Http\Controllers\Admin\CustomerController@edit' ? 'active' : '' }}
        text-semibold"><a href="{{ action('Admin\CustomerController@edit', $customer->uid) }}">
            <i class="icon-user"></i> {{ trans('messages.profile') }}</a>
        </li>
        <li class="
        {{ request()->route()->getActionName() == 'MailChamp\Http\Controllers\Admin\CustomerController@contact' ? 'active' : '' }}
        ...
        <li class="
        {{ request()->route()->getActionName() == 'MailChamp\Http\Controllers\Admin\CustomerController@subscriptions' ? 'active' : '' }}
        ...
        @can('viewSubAccount', $customer))
            <li class="
            {{ request()->route()->getActionName() == 'MailChamp\Http\Controllers\Admin\CustomerController@subAccount' ? 'active' : '' }}
