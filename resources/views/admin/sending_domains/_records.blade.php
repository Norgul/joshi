<table class="table table-trans tbody-white" class="table-layout:fixed">
    ...
    <tbody class="bg-white">
        ...
        <tr>
            ...
            <td><textarea style="width:100%;border:0;height:100px;resize:none;">{{ \MailChamp\Model\Setting::isYes('escape_dkim_dns_value') ? $server->getEscapedDnsDkimConfig() : $server->getDnsDkimConfig() }}</textarea></td>
            <td class="text-right">
