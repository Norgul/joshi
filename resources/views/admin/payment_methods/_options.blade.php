@if ($payment_method->type == \MailChamp\Model\PaymentMethod::TYPE_PAYPAL)
    <div class="row">
        <div class="col-md-4">
...
@if ($payment_method->type == \MailChamp\Model\PaymentMethod::TYPE_BRAINTREE_PAYPAL ||
    $payment_method->type == \MailChamp\Model\PaymentMethod::TYPE_BRAINTREE_CREDIT_CARD
)
    <div class="row">
        <div class="col-md-4">
            @include('helpers.form_control', [
...
@if ($payment_method->type == \MailChamp\Model\PaymentMethod::TYPE_STRIPE_CREDIT_CARD)
    <div class="row">
        <div class="col-md-4">
            @include('helpers.form_control', [
                'type' => 'text',
...
@if ($payment_method->type == \MailChamp\Model\PaymentMethod::TYPE_PADDLE_CARD)
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                'type' => 'text',
...
@if ($payment_method->type == \MailChamp\Model\PaymentMethod::TYPE_PAYU_MONEY)
    <div class="row">
        <div class="col-md-6">
            @include('helpers.form_control', [
                'type' => 'text',
