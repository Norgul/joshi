<div class="row">
	...
	<div class="col-md-4">
		<div class="sub_section">
			...
			@include('helpers.form_control', ['type' => 'select',
											...
											'options' => MailChamp\Model\AdminGroup::getSelectOptions(Auth::user()->admin),
	...
	<div class="col-md-5">
		<div class="sub_section">
			...
			@include('helpers.form_control', ['type' => 'select', 'name' => 'language_id', 'label' => trans('messages.language'), 'value' => $admin->language_id, 'options' => MailChamp\Model\Language::getSelectOptions(), 'include_blank' => trans('messages.choose'), 'rules' => $admin->rules()])
