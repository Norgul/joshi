...
@section('content')
				...
				<form class="listing-form"
					...
					per-page="{{ MailChamp\Model\Admin::$itemsPerPage }}"
				>
					<div class="row top-list-controls">
								...
								<div class="filter-box">
									...
									<span class="filter-group">
										...
										<select class="select" name="admin_group_id">
											...
											@foreach (MailChamp\Model\AdminGroup::getSelectOptions(Auth::user()->admin) as $option)
						...
						@can('create', new MailChamp\Model\Admin())
