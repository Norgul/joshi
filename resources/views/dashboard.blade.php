...
@section('content')
    ...
    <div class="row quota_box">
        ...
        <div class="col-sm-6 col-md-6">
            <div class="content-group-sm">
                <div class="pull-right  text-semibold">
                    <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->campaignsCount()) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxCampaigns()) }}</span>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="content-group-sm">
                <div class="pull-right  text-semibold">
                    <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->readCache('SubscriberCount', 0)) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxSubscribers()) }}</span>
        ...
        <div class="row">
            <div class="col-md-6">
                @include('helpers.form_control', [
                    ...
                    'label' => '',
                    'value' => '',
                    'options' => MailChamp\Model\Campaign::getSelectOptions(Auth::user()->customer, "done"),
                ])
            </div>
        </div>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="top-tab1">
                <ul class="modern-listing mt-0 top-border-none">
                    @forelse (MailChamp\Model\Campaign::topOpens(5, Auth::user()->customer)->get() as $num => $item)
                        <li>
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-md-2 text-left">
                                    <h5 class="no-margin text-bold">
                                        {{ (null !== $item->lastOpen()) ? MailChamp\Library\Tool::formatDateTime($item->lastOpen()->created_at) : "" }}
                                    </h5>
            ...
            <div class="tab-pane" id="top-tab2">
                <ul class="modern-listing mt-0 top-border-none">
                    @forelse (MailChamp\Model\Campaign::topClicks(5, Auth::user()->customer)->get() as $num => $item)
                        <li>
                            <div class="row">
                                <div class="col-sm-5 col-md-5">
                                    <i class="number">{{ $num+1 }}</i>
                                ...
                                <div class="col-sm-2 col-md-2 text-left">
                                    <h5 class="no-margin text-bold">
                                        {{ (null !== $item->lastClick()) ? MailChamp\Library\Tool::formatDateTime($item->lastClick()->created_at) : "" }}
                                    </h5>
            ...
            <div class="tab-pane" id="top-tab3">
                <ul class="modern-listing mt-0 top-border-none">
                    @forelse (MailChamp\Model\Campaign::topLinks(5, Auth::user()->customer)->get() as $num => $item)
                        <li>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <i class="number">{{ $num+1 }}</i>
                                ...
                                <div class="col-sm-2 col-md-2 text-left">
                                    <h5 class="no-margin text-bold">
                                        {{ (null !== $item->lastClick(Auth::user()->customer)) ? MailChamp\Library\Tool::formatDateTime($item->lastClick(Auth::user()->customer)->created_at) : "" }}
                                    </h5>
                                    <span class="text-muted">{{ trans('messages.last_clicked') }}</span>
                                    <br /><br />
                                </div>
