            <h3 class="mt-10"><span class="text-teal text-bold">{{ $campaign->readCache('SubscriberCount', 0) }}</span> {{ trans('messages.' . \MailChamp\Library\Tool::getPluralPrase('recipient', $campaign->readCache('SubscriberCount', 0))) }}</h3>
