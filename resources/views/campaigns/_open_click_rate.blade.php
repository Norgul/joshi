            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="stat-table">
                        ...
                        <div class="stat-row">
                            <div class="pull-right num">
                                {{ is_object($campaign->lastOpen()) ? MailChamp\Library\Tool::formatDateTime($campaign->lastOpen()->created_at) : "" }}
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="stat-table">
                        ...
                        <div class="stat-row">
                            <div class="pull-right num">
                                {{ is_object($campaign->lastClick()) ? MailChamp\Library\Tool::formatDateTime($campaign->lastClick()->created_at) : "" }}
                            </div>
