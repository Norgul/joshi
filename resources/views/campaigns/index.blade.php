...
@section('content')
    <form class="listing-form"
          ...
          per-page="{{ MailChamp\Model\MailList::$itemsPerPage }}"
    >
                    ...
                    <div class="filter-box">
                        ...
                        <div class="btn-group list_actions hide">
                            ...
                            <ul class="dropdown-menu">
                                <li class="list-group-item"><a link-confirm="{{ trans('messages.restart_campaigns_confirm') }}" href="{{ action
                                ('CampaignController@restart') }}"><i class="icon-history"></i> {{ trans("messages.restart") }}</a></li>
                                <li class="list-group-item"><a link-confirm="{{ trans('messages.pause_campaigns_confirm') }}" href="{{ action
                                ('CampaignController@pause') }}"><i class="icon-pause"></i> {{ trans("messages.pause") }}</a></li>
                                <li class="list-group-item"><a delete-confirm="{{ trans('messages.delete_campaigns_confirm') }}" href="{{ action
                                ('CampaignController@delete') }}"><i class="icon-trash"></i> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div><br/><br/>
...
{{--                        </div>--}}
                        <span class="filter-group">
                            ...
                            <select class="form-control select" name="sort-order">
