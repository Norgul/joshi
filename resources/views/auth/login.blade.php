...
<form class="" role="form" method="POST" action="{{ url('/login') }}">
    ...
    <div class="panel panel-body">
	 ...
	 value="{{ old('email') ? old('email') : (isset(\MailChamp\Model\User::getAuthenticateFromFile()['email']) ? \MailChamp\Model\User::getAuthenticateFromFile()['email'] : "") }}"
            >
	...
	value="{{ isset(\MailChamp\Model\User::getAuthenticateFromFile()['password']) ? \MailChamp\Model\User::getAuthenticateFromFile()['password'] : "" }}"
            >
            <div class="form-control-feedback">
	...
	<div class="col-sm-6 text-right text-semibold">
        ...
        @if (\MailChamp\Model\Setting::get('login_recaptcha') == 'yes')
            {!! \MailChamp\Library\Tool::showReCaptcha($errors) !!}
        @endif
    ...
    @if (\MailChamp\Model\Setting::get('enable_user_registration') == 'yes')
