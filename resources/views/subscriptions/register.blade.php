                                ...
                                <div class="col-md-9">
                                    <div class="sub_section">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                @include('helpers.form_control', ['type' => 'select', 'name' => 'language_id', 'label' => trans('messages.language'), 'value' => $customer->language_id, 'options' => MailChamp\Model\Language::getSelectOptions(), 'include_blank' => trans('messages.choose'), 'rules' => $customer->rules()])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                @if (MailChamp\Model\Setting::get('registration_recaptcha') == 'yes')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @endif
                            {!! MailChamp\Library\Tool::showReCaptcha() !!}
                        </div>
                    </div>
                @endif
