...
{{--						@endif--}}
				...
				<td>
					<h5 class="no-margin text-bold">
						<!-- <a class="kq_search" href="{{ action('MailListController@overview', ['uid' => $item->uid]) }}">{{ $item->email }}</a> -->
{{--						<a class="kq_search" href="#">{{ $item->email }}</a>--}}
							{{ $item->email }}
					</h5>
...
{{--						</a>--}}
{{--						<br />--}}
{{--						<span class="text-muted">{{ trans("messages." . MailChamp\Library\Tool::getPluralPrase('subscriber', $item->readCache('SubscriberCount', 0))) }}</span>--}}
{{--					</div>--}}
...
{{--					<a href="#" data-popup="tooltip" title="{{ trans('messages.create_subscriber') }}" type="button" class="btn bg-grey-600 btn-icon"><i class="icon icon-plus2"></i><i class="glyphicon glyphicon-user"></i></a>--}}
{{--					<a href="{{ action('MailListController@overview', $item->uid) }}" type="button" class="btn bg-teal-600 btn-icon">--}}
...
{{--						<ul class="dropdown-menu dropdown-menu-right">--}}
{{--							<li><a href="#"><i class="icon-users4"></i> {{ trans("messages.subscribers") }}</a></li>--}}
{{--							<li><a href="#"><i class="icon-make-group"></i> {{ trans('messages.segments') }}</a></li>--}}
{{--							<li>--}}
{{--								<a href="#">--}}
{{--									<i class="icon-embed2"></i> {{ trans('messages.Embedded_form') }}--}}
{{--								</a>--}}
{{--							</li>--}}
{{--							<li><a href="#"><i class="icon-certificate"></i> {{ trans('messages.custom_forms_and_emails') }}</a></li>--}}
{{--							<li>--}}
{{--								<a class="level-1" href="#">--}}
{{--									<i class="icon-list3"></i> {{ trans('messages.manage_list_fields') }}--}}
{{--								</a>--}}
{{--							</li>--}}
{{--							<li><a href="#"><i class="icon-envelop5"></i> {{ trans("messages.email_verification") }}</a></li>--}}
{{--							<li><a href="#"><i class="icon-pencil7"></i> {{ trans("messages.edit_list") }}</a></li>--}}
{{--							@if (\Auth::user()->can('import', $item))--}}
{{--								<li><a href="#"><i class="icon-download4"></i> {{ trans('messages.import') }}</a></li>--}}
{{--							@endif--}}
{{--							@if (\Auth::user()->can('export', $item))--}}
{{--								<li><a href="#"><i class="icon-upload4"></i> {{ trans('messages.export') }}</a></li>--}}
{{--							@endif--}}
{{--							<li>--}}
{{--								<a data-uid="{{ $item->uid }}" data-name="{{ trans("messages.copy_of_list", ['name' => $item->name]) }}" class="copy-list-link">--}}
{{--									<i class="icon-copy4"></i> {{ trans('messages.copy') }}--}}
...
{{--							</li>--}}
{{--							<li>--}}
{{--								<a list-delete-confirm="{{ action('MailListController@deleteConfirm', ['uids' => $item->uid]) }}" href="#">--}}
{{--									<i class="icon-trash"></i> {{ trans('messages.delete') }}--}}
{{--								</a>--}}
{{--							</li>--}}
{{--						</ul>--}}
