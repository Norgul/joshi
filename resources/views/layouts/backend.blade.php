	...
	<div class="navbar navbar-{{ Auth::user()->admin->getColorScheme() == "white" ? "default" : "inverse" }} navbar-fixed-top">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				...
				@if (Auth::user()->can("read", new MailChamp\Model\Customer())
					|| Auth::user()->admin->can("read", new MailChamp\Model\Subscription())
				)
					...
					>
						...
						<ul class="dropdown-menu">
							...
							@endif
							@if (Auth::user()->admin->can("read", new MailChamp\Model\Subscription()))
				...
				@if (
					Auth::user()->can("read", new MailChamp\Model\Plan())
					|| Auth::user()->can("read", new MailChamp\Model\Currency())
					|| Auth::user()->can("read", new MailChamp\Model\PaymentMethod())
				)
					<li class="dropdown language-switch"
						rel0="PlanController"
					...
					>
						...
						<ul class="dropdown-menu">
							@if (Auth::user()->can("read", new MailChamp\Model\Plan()))
							...
							@endif
							@if (Auth::user()->can("read", new MailChamp\Model\Currency()))
							...
							@endif
							@if (Auth::user()->can("read", new MailChamp\Model\PaymentMethod()))
				...
				@if (
					...
					|| Auth::user()->admin->can('read', new \MailChamp\Model\SubAccount())
				)
					<li class="dropdown language-switch"
					...
					>
						...
						<ul class="dropdown-menu">
							...
							@endif
							@if (Auth::user()->admin->can('read', new \MailChamp\Model\SubAccount()))
