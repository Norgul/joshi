								...
								<div class="row condition-line" rel="{{ $index }}">
									...
									<div class="col-md-3 operator-col">
										@include('helpers.form_control', [
											...
											'options' => MailChamp\Model\AutoEvent::operators()
										])
									</div>
									<div class="col-md-4 value-col" {!! (isset($criteria) && in_array($criteria["operator"], [MailChamp\Model\AutoEvent::OPERATOR_BLANK, MailChamp\Model\AutoEvent::OPERATOR_NOT_BLANK])) ? 'style="visibility: hidden"' : '' !!}>
										@include('helpers.form_control', [
											'type' => 'text',
