        ...
        <div class="row">
            <div class="col-md-6 tabable-select-radio">
                ...
                @include('helpers.form_control', [
                    ...
                    'options' => MailChamp\Model\AutoEvent::typeNameSelectOptions(),
                    'rules' => []
                ])
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <h6 class="panel-title text-semibold auto-event-form-line">
                        ...
                        @include('helpers.form_control', [
                            ...
                            'options' => MailChamp\Model\AutoEvent::delayTypeOptions(),
                            'rules' => []
                        ])
                        ...
                        <span class="tabable-tab subscriber-event">
                            ...
                            @include('helpers.form_control', [
                                ...
                                'label' => '',
                                'class' => ' text-left',
                                'value' => null !== $first_event->getDataValue('at') ? MailChamp\Library\Tool::timeStringFromTimestamp(MailChamp\Library\Tool::dateTimeFromString($first_event->getDataValue('at'))) : '',
                                'rules' => []
                            ])
                        </span>
                    </h6>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("change", "input[name='event_type']", function() {
                ...
                if(type === '{{ MailChamp\Model\AutoEvent::TYPE_CUSTOM_CRITERIA }}' || type === '{{ MailChamp\Model\AutoEvent::TYPE_LIST_UNSUBSCRIPTION }}' || type === '{{ MailChamp\Model\AutoEvent::TYPE_LIST_SUBSCRIPTION }}') {
