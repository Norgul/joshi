					...
					<script>
						$(document).ready(function() {
							...
							$('.pickadate_from_now').pickadate({
								min: [{{ MailChamp\Library\Tool::dateTime(Carbon\Carbon::now())->year }},
										{{ MailChamp\Library\Tool::dateTime(Carbon\Carbon::now()->subMonth(1))->month }},
										{{ MailChamp\Library\Tool::dateTime(Carbon\Carbon::now())->day }}],
