    ...
    <div class="row quota_box">
        <div class="col-md-12">
            <div class="content-group-sm mt-20">
                <div class="pull-right text-teal-800 text-semibold">
                    <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->getSendingQuotaUsage()) }}/{{ (Auth::user()->customer->getSendingQuota() == -1) ? '∞' : \MailChamp\Library\Tool::format_number(Auth::user()->customer->getSendingQuota()) }}</span>
        ...
        <div class="col-md-12">
            <div class="content-group-sm">
                <div class="pull-right text-teal-800 text-semibold">
                    <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->listsCount()) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxLists()) }}</span>
        ...
        <div class="col-md-12">
            <div class="content-group-sm mt-20">
                <div class="pull-right text-teal-800 text-semibold">
                    <span class="text-muted progress-xxs">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->campaignsCount()) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxCampaigns()) }}</span>
        ...
        <div class="col-md-12">
            <div class="content-group-sm">
                <div class="pull-right text-teal-800 text-semibold">
                    <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->readCache('SubscriberCount')) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxSubscribers()) }}</span>
        ...
        <div class="col-md-12">
            <div class="content-group-sm mt-20">
                <div class="pull-right text-teal-800 text-semibold">
                    <span class="text-muted progress-xxs">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->automationsCount()) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxAutomations()) }}</span>
        ...
        <div class="col-md-12">
            <div class="content-group-sm mt-20">
                <div class="pull-right text-teal-800 text-semibold">
                    <span class="text-muted progress-xxs">{{ \MailChamp\Library\Tool::format_number(round(Auth::user()->customer->totalUploadSize(),2)) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxTotalUploadSize()) }} (MB)</span>
        ...
        @if (Auth::user()->customer->can("create", new MailChamp\Model\SendingServer()))
            <div class="col-md-12">
                <div class="content-group-sm">
                    <div class="pull-right text-teal-800 text-semibold">
                        <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->sendingServersCount()) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxSendingServers()) }}</span>
        ...
        @if (Auth::user()->customer->can("create", new MailChamp\Model\EmailVerificationServer()))
            <div class="col-md-12">
                <div class="content-group-sm">
                    <div class="pull-right text-teal-800 text-semibold">
                        <span class="text-muted">{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->emailVerificationServersCount()) }}/{{ \MailChamp\Library\Tool::format_number(Auth::user()->customer->maxEmailVerificationServers()) }}</span>
