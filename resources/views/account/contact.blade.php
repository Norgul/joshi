    ...
    <form enctype="multipart/form-data" action="{{ action('AccountController@contact') }}" method="POST" class="form-validate-jqueryz">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @include('helpers.form_control', ['type' => 'text', 'label' => trans('messages.email_at_work'), 'name' => 'email', 'value' => $contact->email, 'help_class' => 'customer_contact', 'rules' => MailChamp\Model\Contact::$rules])
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @include('helpers.form_control', [
                    ...
                    'rules' => MailChamp\Model\Contact::$rules]
                )
