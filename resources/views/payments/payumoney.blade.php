            ...
            <div class="sub-section">
                <h3 class="text-semibold">{!! trans('messages.pay_by_credit_debit_card') !!}</h3>
                    ...
                    {!! trans('messages.purchasing_intro_' . $payment_method->type, [
                        ...
                        'price' => MailChamp\Library\Tool::format_price($subscription->price, $subscription->currency_format)
                    ]) !!}
                 </p>
              ...
              @endforeach
						  ...
						  <input type="submit" value="Pay {{ MailChamp\Library\Tool::format_price($subscription->price, $subscription->currency_format) }}" class="btn btn-primary bg-teal-800" />
						</form>
					</div>
				</div>
			</div>
