...
@section('content')
                ...
                @elseif($layout->alias == 'sign_up_form_2')
					<p class="alert alert-info mt-20 mb-20">{{ trans('messages.sign_up_form_url') }}<br /> <a target="_blank" href="{{ action('PageController@signUpForm2', ['list_uid' => $list->uid]) }}" class="text-semibold">{{ action('PageController@signUpForm2', ['list_uid' => $list->uid]) }}</a></p>

				@else
					<p class="alert alert-info mt-20 mb-20">{{ trans('messages.sign_up_form_url') }}<br /> <a target="_blank" href="{{ action('PageController@signUpForm3', ['list_uid' => $list->uid]) }}" class="text-semibold">{{ action('PageController@signUpForm3', ['list_uid' => $list->uid]) }}</a></p>
