...
Route::get('/app/templates/{name?}', [ function ($name) {
    ...
    $mime_type = \MailChamp\Library\File::getFileType($path);
    if (\File::exists($path)) {
...
Route::group(['middleware' => ['not_installed']], function () {
    ...
    Route::get('lists/{list_uid}/sign-up-2', 'PageController@signUpForm2');
    Route::post('lists/{list_uid}/sign-up-2', 'PageController@signUpForm2');

    Route::get('lists/{list_uid}/sign-up-3', 'PageController@signUpForm3');
    Route::post('lists/{list_uid}/sign-up-3', 'PageController@signUpForm3');
    ...
    Route::get('/new_form','HomeController@select_list_for_form');
    Route::post('/form_list','HomeController@list_to_show_forms');
    ...
    Route::get('lists/{list_uid}/unsubscribe_form/{uid}/{code}', 'PageController@unsubscribeForm');
    Route::post('lists/{list_uid}/unsubscribe_form/{uid}/{code}', 'PageController@unsubscribeForm');
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend']], function () {
    ...
    Route::get('new', 'HomeController@newpage');
    ...
    Route::resource('lists_subscribers', 'CustomController');
    Route::get('subscriber_lists/listing/{page?}', 'CustomController@listing');
    Route::get('email_reminder', 'EmailReminderController@index');
    Route::post('store/reminder', 'EmailReminderController@save');

    Route::prefix('tag')->group(function () {
        Route::get('lists','TagManagerController@index');
        Route::get('create','TagManagerController@create');
        Route::post('store','TagManagerController@store');
        Route::get('edit/{id}','TagManagerController@edit');
        Route::post('update/{id}','TagManagerController@update');
        Route::get('delete/{id}','TagManagerController@delete');
    ...
    Route::get('lists/subscribers','SubscriberController@allSubscribers');
    // Segment
    ...
    //article spinner
    Route::get('/spinner', 'HomeController@spinner_index');
    Route::post('/spinner', 'HomeController@spinner');


    //purge
    Route::get('/purge', 'HomeController@purge');
    Route::post('/purge-list', 'HomeController@purge_list');
    Route::post('/purge/delete/{email}', 'HomeController@deletePurge');
    Route::get('/pass', 'HomeController@genPassword');

    //spam word detector
    Route::get('/spam-word-scanner', 'HomeController@spam_detector');
    Route::post('/spam-word-scanner/save', 'HomeController@save');
    ...
    Route::get('lists/{list_uid}/pages2/{alias}/update2', 'PageController@update2');
    Route::post('lists/{list_uid}/pages2/{alias}/update2', 'PageController@update2');
    Route::post('lists/{list_uid}/pages2/{alias}/preview2', 'PageController@preview2');

    Route::get('lists/{list_uid}/pages3/{alias}/update3', 'PageController@update3');
    Route::post('lists/{list_uid}/pages3/{alias}/update3', 'PageController@update3');
    Route::post('lists/{list_uid}/pages3/{alias}/preview3', 'PageController@preview3');
    ...
    Route::get('form_templates','HomeController@form_templates');
