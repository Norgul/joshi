...
-d contact[country_id]=' . \MailChamp\Model\Country::first()->id . ' \
                    ...
                    'parameters' => [
                        ...
                        ['name' => '$options[...]', 'description' => 'Plan\'s options...<br>
                            <ul>
                                ...
                                <li><span class="text-semibold">sending_server_option</span>: ('.\MailChamp\Model\Plan::SENDING_SERVER_OPTION_SYSTEM.'|'.\MailChamp\Model\Plan::SENDING_SERVER_OPTION_OWN.'|'.\MailChamp\Model\Plan::SENDING_SERVER_OPTION_SUBACCOUNT.')</li>
...
-d api_token=' . \Auth::user()->api_token . '  \
-d name=Advanced \
-d currency_id=' . \MailChamp\Model\Currency::first()->id . ' \
-d frequency_amount=1 \
-d frequency_unit=month \
-d price=20 \
-d color=red \
-d options[sending_server_option]=' . \MailChamp\Model\Plan::SENDING_SERVER_OPTION_OWN . ' \
...
-d api_token=' . \Auth::user()->api_token . '  \
-d files=\'[{"url":"http://demo.qubolt.com/images/logo_big.png","subdirectory":"path/to/file"},{"url":"http://demo.qubolt.com/images/logo_big.png","subdirectory":"path/to/file2"}]\'',
                ],
            ],
        ];
