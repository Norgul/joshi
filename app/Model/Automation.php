...
class Automation extends Model
{
    ...
    {
        return $this->belongsToMany('MailChamp\Model\MailList', 'automations_lists_segments', 'automation_id', 'mail_list_id');
    }
    ...
    {
        return $this->hasMany('MailChamp\Model\AutoEvent');
    }
    ...
    public function subscribers($params = [])
    {
        ...
        $query->where('subscribers.status', \MailChamp\Model\Subscriber::STATUS_SUBSCRIBED);
    ...
    {
        return $this->hasMany('MailChamp\Model\AutomationsListsSegment');
    }
    ...
    {
        event(new \MailChamp\Events\AutomationUpdated($this));
    }
}
