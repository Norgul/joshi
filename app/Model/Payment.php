...
class Payment extends Model
{
    ...
    {
        return $this->belongsTo('MailChamp\Model\Subscription');
    }
    ...
    public function getErrorMessages()
    {
        ...
        if ($this->paymentMethod->type == \MailChamp\Model\PaymentMethod::TYPE_BRAINTREE_PAYPAL ||
            $this->paymentMethod->type == \MailChamp\Model\PaymentMethod::TYPE_BRAINTREE_CREDIT_CARD) {
        ...
        if ($this->paymentMethod->type == \MailChamp\Model\PaymentMethod::TYPE_PAYPAL) {
