...
class Language extends Model
{
    ...
    {
        return $this->hasMany('MailChamp\Model\User');
    }
    ...
    {
        return $this->hasMany('MailChamp\Model\Admin');
    }
    ...
    public static function boot()
    {
        ...
        static::created(function ($item) {
            ...
            if (!file_exists($des)) {
                ...
                \MailChamp\Library\Tool::xcopy($sou, $des);
                umask($oldmask);
            }
        });
        ...
        static::deleted(function ($item) {
            ...
            $des = $item->languageDir();
            if (file_exists($des)) {
                \MailChamp\Library\Tool::xdelete($des);
            }
        });
    }
    ...
    {
        return new \MailChamp\Model\Language([
            'name' => 'Default',
            'code' => 'default',
        ]);
    }
    ...
    {
        return \MailChamp\Model\Language::where('is_default', '=', true)->first();
    }
