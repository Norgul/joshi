...
class Template extends Model
{
    ...
    public static function boot()
    {
        ...
        static::deleted(function ($item) {
            ...
            \MailChamp\Library\Tool::xdelete($uploaded_dir);
        });
    }
    ...
    {
        $this->content = \MailChamp\Library\Tool::replaceHtmlUrl($this->content, $template_path);
    }
    ...
    public function copy($name, $customer = null, $admin = null)
    {
        ...
        if (file_exists($this->getUploadDir())) {
            ...
            \MailChamp\Library\Tool::xcopy($this->getUploadDir(), $copy->getUploadDir());
            // replace image url
