...
class SubAccountSendGrid extends SubAccount
{
    ...
    {
        return $this->belongsTo('MailChamp\Model\SendingServerSendGrid', 'sending_server_id');
    }
    ...
    public function updateApiKey()
    {
        try {
            // create an API key
            $response = $this->getApiClient()->createApiKey(['name' => 'Mail Champ']);
    ...
    {
        $client = new \MailChamp\Extra\SendGrid(['username' => $this->getSubAccountUsername(), 'password' => decrypt($this->password)]);
    ...
    public function getMasterApiClient()
    {
        ...
        $client = new \MailChamp\Extra\SendGrid(['api' => $master->api_key]);
