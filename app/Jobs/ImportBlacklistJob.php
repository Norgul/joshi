...
use MailChamp\Library\Log as CustomLog;
...
class ImportBlacklistJob extends ImportExportJob
{
    ...
    public function __construct($file, $customer=NULL, $admin=NULL)
    {
        ...
        $this->updateStatus([
            ...
            'status' => \MailChamp\Model\Blacklist::IMPORT_STATUS_NEW,
            'error_message' => '',
            'total' => 0,
            'processed' => 0,
        ]);
    ...
    {
        \MailChamp\Model\Blacklist::import($this->file, $this, $this->customer, $this->admin);
    }
