...
class PageController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $layout = \MailChamp\Model\Layout::where('alias', $request->alias)->first();
...
//        dd($layout);
    ...
    {
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'sign_up_form')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
        ...
        // Create subscriber
        if ($request->isMethod('post')) {
            $subscriber = \MailChamp\Model\Subscriber::where("email", "=", strtolower($request->EMAIL))
            ...
            if($list->subscribe_confirmation) {
                ...
                $layout = \MailChamp\Model\Layout::where('alias', 'sign_up_confirmation_thankyou')->first();
                $page = \MailChamp\Model\Page::findPage($list, $layout);
...
//dd($page);
    ...
    {
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'sign_up_form_2')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
...
//dd($page);
    ...
    {
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'sign_up_form_3')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
...
//dd($page);
    ...
    {
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'sign_up_thankyou_page')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
        $subscriber = \MailChamp\Model\Subscriber::findByUid($request->subscriber_uid);
    ...
    public function unsubscribeForm(Request $request)
    {
        $user = $request->user();
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'unsubscribe_form')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
        $subscriber = \MailChamp\Model\Subscriber::findByUid($request->uid);
    ...
    public function profileUpdateForm(Request $request)
    {
        $user = $request->user();
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'profile_update_form')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
        $subscriber = \MailChamp\Model\Subscriber::findByUid($request->uid);
    ...
    public function profileUpdateSuccessPage(Request $request)
    {
        $user = $request->user();
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'profile_update_success_page')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
        $subscriber = \MailChamp\Model\Subscriber::findByUid($request->uid);
    ...
    public function profileUpdateEmailSent(Request $request)
    {
        $user = $request->user();
        $list = \MailChamp\Model\MailList::findByUid($request->list_uid);
        $layout = \MailChamp\Model\Layout::where('alias', 'profile_update_email_sent')->first();
        $page = \MailChamp\Model\Page::findPage($list, $layout);
        $subscriber = \MailChamp\Model\Subscriber::findByUid($request->uid);
