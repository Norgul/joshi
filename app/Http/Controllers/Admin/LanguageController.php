...
class LanguageController extends Controller
{
    ...
    {
        if (\Gate::denies('read', new \MailChamp\Model\Language())) {
            return $this->notAuthorized();
        }

        $items = \MailChamp\Model\Language::getAll();
    ...
    public function listing(Request $request)
    {
        ...
        $items = \MailChamp\Model\Language::search($request)->paginate($request->per_page);
    ...
    {
        $language = new \MailChamp\Model\Language([
    ...
    {
        $language = \MailChamp\Model\Language::findByUid($id);
    ...
    {
        $items = \MailChamp\Model\Language::whereIn('uid', explode(',', $request->uids));
    ...
    {
        $languages = \MailChamp\Model\Language::whereIn('uid', explode(',', $request->uids));
