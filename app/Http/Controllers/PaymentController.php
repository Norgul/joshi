...
use MailChamp\Model\Payment;
use MailChamp\Library\Log as PaymentLog;
...
class PaymentController extends Controller
{
    ...
    public function billingInformation(Request $request, $subscription_uid)
    {
        ...
        $subscription = \MailChamp\Model\Subscription::findByUid($subscription_uid);
        $billing_information = [];
    ...
    public function paypal(Request $request, $subscription_uid)
    {
        ...
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_PAYPAL);
        ...
        if ($request->isMethod('post')) {
            try {
                ...
                $payment->status = $result->success ? \MailChamp\Model\Payment::STATUS_SUCCESS : \MailChamp\Model\Payment::STATUS_FAILED;
    ...
    public function braintree_credit_card(Request $request, $subscription_uid)
    {
        ...
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_BRAINTREE_CREDIT_CARD);
    ...
    public function braintree_paypal(Request $request, $subscription_uid)
    {
        ...
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_BRAINTREE_PAYPAL);
    ...
    {
        $subscription = \MailChamp\Model\Subscription::findByUid($subscription_uid);
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_CASH);
        ...
        $payment->subscription_id = $subscription->id;
        $payment->payment_method_id = $payment_method->id;
        $payment->status = \MailChamp\Model\Payment::STATUS_CASH_MANUAL_CONFIRMATION;
        $payment->action = \MailChamp\Model\Payment::ACTION_PAID;
        $payment->payment_method_name = trans('messages.' . $payment_method->type);
    ...
    public function stripe_credit_card(Request $request, $subscription_uid)
    {
        ...
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_STRIPE_CREDIT_CARD);
    ...
    public function paddle_card(Request $request, $subscription_uid)
    {
        ...
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_PADDLE_CARD);
    ...
    public function paddle_card_hook(Request $request, $subscription_uid)
    {
        ...
        if ($verified) {
            ...
            $payment->status = \MailChamp\Model\Payment::STATUS_SUCCESS; // : \MailChamp\Model\Payment::STATUS_FAILED;
    ...
    public function payumoney(Request $request, $subscription_uid)
    {
        ...
        $payment_method = \MailChamp\Model\PaymentMethod::getByType(\MailChamp\Model\PaymentMethod::TYPE_PAYU_MONEY);
        $rules = [
            'name' => 'required',
            'emails' => 'required',
            'phones'=>'required',
    ...
    public function payumoney_fail(Request $request, $subscription_uid)
    {
        ...
        try {
            ...
            if ($request->isMethod('post')) {
                ...
                $payment->data = serialize($result);
                $payment->payment_method_id = $payment_method->id;
                $payment->status = \MailChamp\Model\Payment::STATUS_FAILED;
                $payment->action = \MailChamp\Model\Payment::ACTION_PAID;
                $payment->payment_method_name = trans('messages.' . $payment_method->type);
                $payment->order_id = $order_id;
