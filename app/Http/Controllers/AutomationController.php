...
class AutomationController extends Controller
{
    ...
    {
        $automations = \MailChamp\Model\Automation::search($request)->paginate($request->per_page);
    ...
    {
        $automation = new \MailChamp\Model\Automation();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $automation->status = \MailChamp\Model\Automation::STATUS_DRAFT;
            $automation->save();
    ...
    {
        $automation = \MailChamp\Model\Automation::findByUid($uid);
    ...
    public function delete(Request $request)
    {
        ...
        $automations = \MailChamp\Model\Automation::whereIn('uid', explode(',', $request->uids));
    ...
    public function sort(Request $request)
    {
        ...
        foreach ($sort as $row) {
            $item = \MailChamp\Model\Automation::findByUid($row[0]);
