...
<html lang="en">
<head>
	<title>Requirement - MailChamp Installation</title>
...
<body class="bg-slate-800">
	...
	<div class="text-right">                                    
		...
		<div class="footer text-white">
			&copy; 2016. <span class="text-white">MailChamp Email Marketing Application</span> by <a href="http://qubolt.com" class="text-white" target="_blank">qubolt.com</a>			
		</div>
		<!-- /footer -->
